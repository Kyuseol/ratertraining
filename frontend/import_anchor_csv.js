...
if (!supabaseUrl || !supabaseKey) {
  ...
  console.error('.env 파일에 REACT_APP_SUPABASE_URL과 REACT_APP_SUPABASE_ANON_KEY를 설정해주세요.');
  process.exit(1);
}

const supabase = createClient(supabaseUrl, supabaseKey);

// CSV 파일 경로 (사용자가 제공한 경로)
const csvPath = 'g:\\내 드라이브\\1 소논문 쓰기\\00 MFRM 쓰기 평가 문식성 연습 앱\\anchor.csv';
